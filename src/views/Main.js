...
render() {
    ...
    return (
        <div>
            ...
            <section id = 'about' className = 'section-full content-centered bg-image'>
            ...
            <section id = 'skills' className = 'section-full content-centered p-b-2 bg-dark border-top '>
                <div className = 'container-600'>
                    ...
                    <div className = 'flex-container'>
                        ...
                        <div className = { this.state.skillAnimation ? 'skill-card spin-interval-1' : 'skill-card hidden'}>
                            <h4 className = 'text-center text-gradient p-4'><i className="fas fa-mobile-alt text-gradient"></i> Responsive Design</h4>
                        ...
                        <div className = { this.state.skillAnimation ? 'skill-card spin-interval-2' : 'skill-card hidden'}>
                            <h4 className = 'text-center text-gradient p-4'><i className="fas fa-palette text-gradient"></i> Styling</h4>
                        ...
                        <div className = { this.state.skillAnimation ? 'skill-card spin-interval-3' : 'skill-card hidden'}>
                            <h4 className = 'text-center text-gradient p-4'><i className="fas fa-toolbox text-gradient"></i> Functionality</h4>
                        ...
                        <div className = { this.state.skillAnimation ? 'skill-card spin-interval-4' : 'skill-card hidden'}>
                            <h4 className = 'text-center text-gradient p-4'><i className="fas fa-server text-gradient"></i> Full-Stack Development</h4>
            ...
            <section id = 'portfolio' className = 'section-full content-centered gradient border-top'>
                <div className = 'container-1200'>
                    ...
                    <div className = 'flex-container'>
                        ...
                        <div className = 'portfolio-card'>
                            <img alt = 'Site Screenshot' src = {streamrimg}></img>
                            <div>
                        ...
                        <div className = 'portfolio-card'>
                            <img alt = 'Site Screenshot' src = {forumimg} />
                            <div>
                        ...
                        <div className = 'portfolio-card '>
                            <img alt = 'Site Screenshot' src = {newsagimg} />
                            <div>
